...
public class TestRhinoLessCssProcessor {
  ...
  public void testFromFolder()
      throws Exception {
    final ResourceProcessor processor = new RhinoLessCssProcessor();
  ...
  public void shouldWorkProperlyWithCssImportPreProcessor()
      throws Exception {
    final ResourceProcessor processor = ChainedProcessor.create(new CssImportPreProcessor(), new RhinoLessCssProcessor());
    final URL url = getClass().getResource("lesscss");
