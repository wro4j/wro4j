...
(function($){ 
	...
	$.fn.invalidCharacters = 'Invalid characters (use only letters and numbers)';
	$.fn.tooWeak = 'Too weak (use both letters and numbers)';
		 ...
		 var defaults = {
		 	...
		 	return this.each(function() { 
		 		...
		 		$.fn.teststrength = function(password,username,option){
		 			    ...
		 			    if(!password.match(/^$|^[a-zA-Z0-9]*(?=[a-zA-Z0-9]*\d)(?=[a-zA-Z0-9]*[a-zA-Z])[a-zA-Z0-9]*$/)) {
		 			    	this.resultStyle = option.badPass;
		 			    	return $(this).tooWeak;
		 			    }
