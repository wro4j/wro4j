...
/**
 * HandlebarsJS is a JavaScript templating engine which provides the power necessary to let you
...
public class HandlebarsJs {
  ...
  public String compile(final String content, final String name) {
    ...
    final String compileScript =
      String.format("Handlebars.precompile(%s);", WroUtil.toJSMultiLineString(content));
    return HANDLEBARS_JS_TEMPLATES_INIT +
