...
public class TestJsLintProcessor extends AbstractTestLinterProcessor {
	...
	public void testWithOptionsSet() throws Exception {
		final ResourcePostProcessor processor = new JsLintProcessor() {
			@Override
			protected void onLinterException(final LinterException e,
	...
	@Test(expected = LinterException.class)
	public void shouldFailWhenScriptContainsErrors() throws Exception {
		final ResourcePostProcessor processor = new JsLintProcessor() {
			@Override
			protected void onLinterException(final LinterException e,
					final Resource resource) {
	...
	public void canBeExecutedMultipleTimes() throws Exception {
		...
		final Callable<Void> task = new Callable<Void>() {
			...
			public Void call() {
				try {
					processor.process(null, new StringReader("var i = 1;"),
							new StringWriter());
