  ...
  private WroModelFactory createValidModelFactory() {
    return new XmlModelFactory() {
      ...
      protected ResourceLocator getModelResourceLocator() {
        return new UrlResourceLocator(TestWroFilter.class.getResource("wro.xml"));
      }
    };
  }
  ...
  private void initVictimWithMockAuthManager() {
    victim = new WroFilter() {
      ...
      Injector getInjector() {
        return new InjectorBuilder(new BaseWroManagerFactory().setResourceLocatorFactory(mockUriLocatorFactory)).setResourceAuthorizationManager(
