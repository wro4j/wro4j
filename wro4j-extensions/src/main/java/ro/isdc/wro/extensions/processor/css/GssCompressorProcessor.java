...
/**
 * Uses Google closure stylesheet for css minimization and optimization.
 */
@Minimize
@SupportedResourceType(ResourceType.CSS)
public class GssCompressorProcessor
    ...
    private static class WroGssCompiler
            extends DefaultCommandLineCompiler {
        
        private WroGssCompiler(JobDescription job, ExitCodeHandler exitCodeHandler, ErrorManager errorManager) {
    ...
    public void process(final Resource resource, final Reader reader, final Writer writer)
        ...
        try {
            ...
            try {
                ...
                JobDescription job = new JobDescriptionBuilder().addInput(new SourceCode(fileName, content))
                ...
                .setAllowedNonStandardFunctions(
                        Arrays.asList("-webkit-linear-gradient()", "-webkit-gradient()", "from()", "to()"))
                
                .setProcessDependencies(true)
                
                .getJobDescription();
                
                WroGssCompiler compiler = new WroGssCompiler(job, new DefaultExitCodeHandler(), errorManager);
