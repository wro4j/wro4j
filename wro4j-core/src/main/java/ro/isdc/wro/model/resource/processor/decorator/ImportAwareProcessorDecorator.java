...
public class ImportAwareProcessorDecorator
  ...
  public ImportAwareProcessorDecorator(final ResourceProcessor processor, final ProcessingType processingType) {
    super(processor);
  ...
  private boolean isApplicable() {
    return ProcessingType.ALL == processingType || isImportAware() && processingType == ProcessingType.IMPORT_ONLY;
  }
}
