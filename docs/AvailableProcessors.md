...
| cssDataUri | [Base64DataUriSupport CssDataUriPreProcessor] | Rewrites background images by replacing the url with data uri of the image. For more details see [Base64DataUriSupport] |
...
| uglifyJs | UglifyJsProcessor | Compress js using [https://github.com/mishoo/UglifyJS uglifyJs utility]. |
| beautifyJs | UglifyJsProcessor | Does exactly the opposite of uglifyJs. |
| packerJs | PackerJsProcessor | Uses [http://dean.edwards.name/packer/ Dean Edwards packer utility] to pack js resources. |
| lessCss | [LessCssSupport LessCssProcessor] | Transforms less css code into vanilla css. | 
| sassCss | [SassCssSupport SassCssProcessor] | Transforms sass css code into vanilla css. |
| rubySassCss | [RubySassCss RubySassCssProcessor] | Available since 1.4.6. Similar to sassCss, but uses ruby instead of rhino & js. |
...
| coffeeScript | [CoffeeScriptSupport CoffeeScriptProcessor] | Uses [http://jashkenas.github.com/coffee-script/ coffee script] to compile to javascript code. |
...
| jsHint | JsHintProcessor | Does the static analysis of the javascript code using [http://jshint.com/ jsHint] code quality tool.|
| jsLint | JsLintProcessor | Does the static analysis of the javascript code using [http://jslint.com/ jsLint] code quality tool. Available since 1.4.2 release.|
...
| dustJs | [DustJsProcessor] | Uses [http://akdubya.github.com/dustjs/ DustJs] engine to compile a template into javascript. Available since 1.4.5|
| handlebarsJs | [HandlebarsJsProcessor] | Compiles [http://handlebarsjs.com/precompilation.html HandlebarsJS] templates to javascript. Available since 1.4.7|
| hoganJs | [HoganJsProcessor] | Compiles [http://twitter.github.com/hogan.js/ hogan.js] templates to javascript. Available since 1.4.5|
| bourbonCss | [BourbonCssProcessor] | A processor to support the [http://thoughtbot.com/bourbon/ bourbon mixins library] for sass. Available since 1.4.7 |
| typeScript | TypeScriptProcessor | Compiles the [http://www.typescriptlang.org/ typescript] code into javascript. Available since 1.6.0. Uses node.js for compilation. Not supported on all platforms. |
| less4j | Less4jProcessor | Available since 1.6.0. Compiles less into css. Uses [https://github.com/SomMeri/less4j less4j] open source java library | 
| emberJs | EmberJsProcessor | Available since 1.6.2. Compiles templates into javascript using [http://emberjs.com/ emberjs] library. |