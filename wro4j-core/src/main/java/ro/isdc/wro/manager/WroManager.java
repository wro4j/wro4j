...
/**
 * WroManager. Contains all the factories used by optimizer in order to perform
 * the logic.
 * 
...
public final class WroManager {
  ...
  /**
   * A cacheStrategy used for caching processed results. Key: uri, Value:
   * processed result.
   */
  ...
  /**
   * Perform processing of the uri and depending on it will return
   * {@link WroProcessResult} object containing the input stream of the
   * requested resource and it's content type.
   * 
   * @param uri
   * @return
   */
   ...
   *          the resourceLocatorFactory to set
   */
  public final void setUriLocatorFactory(
   ...
   *          the cache to set
   */
  public final void setCacheStrategy(
      final CacheStrategy<String, String> cacheStrategy) {
