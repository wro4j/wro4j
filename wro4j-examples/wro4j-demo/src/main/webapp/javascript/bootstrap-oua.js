  ...
  * ===================== */
  ...
  function escape() {
    ...
    if (this.isShown && this.options.keyboard) {
      $(document).delegate('', 'keyup.dismiss.modal', function ( e ) {
        e.which == 27 && that.hide()
      })
    } else if (!this.isShown) {
      $(document).undelegate('', 'keyup.dismiss.modal')
    }
  }
...
!function( $ ) {
 ...
 "use strict"
  ...
  , show: function() {
      ...
      this.tip().delegate('.close', 'click.popover.hide', $.proxy(this.hide, this))
    }
  ...
  * ======================= */
  ...
  $.fn.popover.defaults = $.extend({} , $.fn.tooltip.defaults, {
    placement: 'right'
  , content: ''
  , template: '<div class="popover"><div class="arrow"></div><div class="popover-inner"><a class="close">&times;</a><h3 class="popover-title"></h3><div class="popover-content"><div class="popover-inner-content"></div></div></div></div>'
  })
...
!function( $ ){
  ...
  , show: function () {
      var dimension = this.dimension()
        , scroll = ['scroll', dimension].join('-').replace(/-([a-z]|[0-9])/ig, function(all, letter) {
