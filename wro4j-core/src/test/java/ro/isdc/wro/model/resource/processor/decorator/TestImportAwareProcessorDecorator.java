...
public class TestImportAwareProcessorDecorator {
  ...
  public void shouldInvokePreProcessorWhenImportIsSupported()
      throws Exception {
    final ResourceProcessor processor = Mockito.spy(new ImportAwareProcessor());
  ...
  public void shouldLeaveContentUnchangedWhenProcessorIsSkipped()
    ...
    Mockito.verify(mockPostProcessor, Mockito.never()).process(Mockito.any(Resource.class), Mockito.any(Reader.class),
        Mockito.any(Writer.class));
