 ...
 */
public class TestVaadinSassProcessor {
  /** Location (base) of ruby sass css test resources. */
  private final URL url = getClass().getResource("vaadinsass");

  /** A RubySassEngine to test */
  private VaadinSassProcessor processor;

  @Before
  public void setUp() {
    processor = new VaadinSassProcessor();
  }
