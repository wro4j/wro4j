...
public class TokenMapper {
  ...
  public TokenMapper(final ScriptOrFnNode parseTree) {
   ...
   *            variables names
   */
  private void collectFunctionMappings(final ScriptOrFnNode parseTree) {
    final int level = -1;
   ...
   *            scoping level
   */
  private void collectFuncNodes(final ScriptOrFnNode parseTree, int level, final ScriptOrFnNode parent) {
    level++;
   ...
   */
  public int sourceCompress(final String encodedSource, int offset,
      final boolean asQuotedString, final StringBuffer sb, final int prevToken,
      final boolean inArgsList, final int currentLevel, final ReplacedTokens replacedTokens) {
