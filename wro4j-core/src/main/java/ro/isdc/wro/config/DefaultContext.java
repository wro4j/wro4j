...
public class DefaultContext
   ...
   */
  private static final Map<String, DefaultContext> CONTEXT_MAP = Collections.synchronizedMap(new HashMap<String, DefaultContext>());
  /**
   * Holds a correlationId, created in {@link WroFilter}. A correlationId will be associated with a {@link DefaultContext}
   * object.
   */
   ...
   */
  public static DefaultContext webContext(final HttpServletRequest request, final HttpServletResponse response,
    final FilterConfig filterConfig) {
    return new DefaultContext(request, response, filterConfig);
  }
   ...
   */
  public static DefaultContext standaloneContext() {
    return new DefaultContext();
  }


  /**
   * @return {@link DefaultContext} associated with CURRENT request cycle.
   */
  ...
  /**
   * Checks if the {@link DefaultContext} is accessible from current request cycle.
   */
   ...
   */
  public static void set(final DefaultContext context) {
   ...
   *
   * @param context {@link DefaultContext} to set.
   */
  public static void set(final DefaultContext context, final WroConfiguration config) {
   ...
   * Constructor.
   */
  private DefaultContext(final HttpServletRequest request, final HttpServletResponse response, final FilterConfig filterConfig) {
  ...
  /**
   * Remove the correlationId from the current thread. This operation will not remove the {@link DefaultContext} associated
   * with the correlationId. In order to remove context, call {@link DefaultContext#unset()}.
   * <p/>
