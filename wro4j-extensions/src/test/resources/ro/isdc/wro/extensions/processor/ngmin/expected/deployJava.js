var deployJava = function () {
    var hattrs = {
      ...
      }, object_valid_attrs = hattrs.object.concat(hattrs.core, hattrs.i18n, hattrs.events), applet_valid_attrs = hattrs.applet.concat(hattrs.core), loc, i;
    ...
    var rv = {
        ...
        launchWebStartApplication: function (jnlp) {
          ...
          if (browser === 'MSIE') {
            ...
            launchTag = '<' + 'embed type="application/x-java-applet;jpi-version=' + this.firefoxJavaVersion + '" ' + 'width="0" height="0" ' + 'launchjnlp="' + jnlp + '"' + 'docbase="' + jnlpDocbase + '"' + ' />';
          }
...
YUI.add('testmodule-footer', function (Y) {
  var namespace = Y.namespace('BF.Modules'), Footer, proto, CONST = Y.namespace('BF.Const');
  Footer = {
    DOM_EVENTS: {
      'click': 1,
      'keypress': 1
  ...
  proto = {
    initializer: function () {
      Y.log('initializer', 'debug', 'testmodule-footer');
    },
    renderUI: function () {
    ...
    destructor: function () {
      Y.log('destructor', 'debug', 'testmodule-footer');
    }
  };
  namespace.Footer = Y.Base.create('Footer', namespace.Module, [], proto, Footer);
}, '1', { requires: ['testmodule-module'] });