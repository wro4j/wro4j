...
public class BenchmarkProcessors {
  ...
  private ResourceLocatorFactory locator;
  private Injector injector;
  @Before
  public void setUp() {
    Context.set(Context.standaloneContext());
    locator = new UrlResourceLocatorFactory();
  ...
  public void test() throws Exception {
    ...
    final List<ResourceProcessor> processors = loadProcessors();
  ...
  private ExceptionHandlingProcessorDecorator decorateProcessor(final ResourceProcessor processor) {
  ...
  private List<ResourceProcessor> loadProcessors() {
