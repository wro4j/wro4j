...
public class PathPatternProcessorDecorator
   ...
   */
  private PathPatternProcessorDecorator(final ResourceProcessor processor, final boolean includes, final String... patterns) {
    super(processor);
   ...
   */
  public static PathPatternProcessorDecorator include(final ResourceProcessor processor, final String... patterns) {
   ...
   * @return decorated processor.
   */
  public static PathPatternProcessorDecorator exclude(final ResourceProcessor processor, final String... patterns) {
