...
public final class WroConfiguration
    ...
    /**
     * When true, will run in parallel preprocessing of multiple resources. In theory this should improve the
     * performance. By default this flag is false, because this feature is experimental.
     */
     ...
     *            flag for turning on/off failure when there is an empty group (nothing to process). This value is true
     *            by default, meaning that empty group will produce empty result (no exception).
     */
